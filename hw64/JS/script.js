...
(function () {
    ...
    Student.prototype.setAttendance = function (flag) {
        ...
        if (emptyIndex !== -1) return this.attendanceList[emptyIndex] = flag;
    }
    ...
    Student.prototype.mark = function (mark) {
        ...
        if (this.attendanceList.length > 10) throw new Error('Количество занятий ошибочно');
        const presentAttendanceCount = this.attendanceList.filter((item) => item !== null).length - 1;
        return this.marksArr[presentAttendanceCount] = mark;
    };
